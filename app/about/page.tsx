...
export const metadata: Metadata = {
  title: "About N3urali.art - AI-Powered 360° Photography Pioneers",
  description:
    "Learn how N3urali.art revolutionizes immersive imagery with AI-generated 360° photography. Discover our mission, technology, and commitment to professional-grade visual content for VR, projection mapping, and architectural visualization.",
  keywords: [
    "about n3urali.art",
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-pretty">
              ...
              360° content that transforms how people experience digital environments.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="p-6">
                <CardContent className="p-0">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    technology. This means unique scenes that don't exist anywhere else, with perfect lighting and
                    composition that would be impossible to capture naturally.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="p-6">
                <CardContent className="p-0">
                  ...
                  <p className="text-muted-foreground">
                    Our custom enhancement pipeline transforms AI output into professional imagery with 4K-16K
                    resolution. Every image meets the demanding standards required for commercial VR applications,
          ...
          <section className="mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground text-pretty">
                Common questions about N3urali.art, our technology, and how we create professional 360° imagery.
              </p>
            </div>
            ...
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem value="company-background" className="bg-card rounded-lg px-6">
                <AccordionTrigger className="text-left">
                  What is N3urali.art and how did the company start?
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  N3urali.art is a pioneering company in AI-generated 360° photography, founded to bridge the gap
                  between traditional photography limitations and the growing demand for immersive visual content. We
                  recognized that creating high-quality 360° imagery was expensive, time-consuming, and often impossible
                  for many creative scenarios. Our solution combines cutting-edge AI generation with professional
                  enhancement techniques to deliver unique, high-quality immersive imagery that meets professional
                  standards.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="ai-vs-traditional" className="bg-card rounded-lg px-6">
                ...
                <AccordionContent className="text-muted-foreground">
                  ...
                  traditional photography captures real environments, our AI approach creates entirely new worlds with
                  professional-grade quality, often exceeding what's possible with conventional equipment and
                  techniques.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="quality-standards" className="bg-card rounded-lg px-6">
                <AccordionTrigger className="text-left">
                  What quality standards does N3urali.art maintain?
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  We maintain rigorous quality standards throughout our entire pipeline. Every image undergoes
                  professional enhancement to achieve 4K-16K resolution with superior clarity, color accuracy, and
                  detail. Our proprietary enhancement process ensures consistent quality that meets the demanding
                  requirements of commercial VR applications, projection mapping installations, and architectural
                  visualization projects. We test every image for technical specifications and visual quality before
                  making it available.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="custom-projects" className="bg-card rounded-lg px-6">
                <AccordionTrigger className="text-left">
                  Does N3urali.art offer custom 360° imagery projects?
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  Yes, we offer custom 360° imagery projects for clients with specific requirements. Our AI generation
                  capabilities allow us to create unique environments, architectural spaces, or artistic scenes tailored
                  to your project needs. Custom projects include consultation on technical specifications, multiple
                  revision rounds, and delivery in your preferred formats and resolutions. Contact us to discuss your
                  specific requirements and timeline for custom imagery solutions.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="technology-pipeline" className="bg-card rounded-lg px-6">
                <AccordionTrigger className="text-left">
                  Can you explain N3urali.art's technology pipeline?
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  Our technology pipeline consists of three main stages: AI generation using proprietary models trained
                  specifically for 360° imagery, professional enhancement through custom-built tools that improve
                  resolution and quality, and quality assurance testing to ensure every image meets our professional
                  standards. Every tool in our pipeline is built from scratch, giving us complete control over the
                  creative process and final output quality. This approach allows us to consistently deliver unique,
                  high-quality imagery that exceeds traditional photography limitations.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </section>

...
import { ArrowLeft, Wallet, Lock, ShoppingCart, CheckCircle, Copy, QrCode, CreditCard } from "lucide-react"
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">Pay with credit card or cryptocurrency</p>
        </div>

...
export const metadata: Metadata = {
  ...
  description:
    "Discover our curated collection of ultra high-quality AI-generated equirectangular and fisheye images, created by our advanced platform. Perfect for projection mapping, VR experiences, and architectural visualization. Professional quality 4K-16K resolution with supreme standards.",
  keywords: [
    "360 photography",
  ...
  openGraph: {
    title: "N3urali.art - Premium 360° Digital Photography & AI-Generated Imagery",
    description:
      "Discover our curated collection of ultra high-quality AI-generated equirectangular and fisheye images, created by our advanced platform. Perfect for projection mapping, VR experiences, and architectural visualization.",
    type: "website",
        ...
        <div className="relative container mx-auto px-4 py-24 lg:py-32">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto text-pretty">
              ...
              advanced AI platform. Perfect for projection mapping, VR experiences, and architectural visualization.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold">Ultra High-Quality Platform:</h3>
                <ul className="space-y-2 text-muted-foreground">
                  <li>• Every image is generated by our advanced AI platform with supreme quality standards</li>
                  <li>• Professional enhancement pipeline ensures ultra high-quality output</li>
                  <li>• Unique scenes created by our proprietary platform technology</li>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground text-pretty">
              ...
              platform, delivering unprecedented quality and detail in every 360° image.
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground pl-11">
                  Every image begins with our advanced AI platform, creating unique 360° environments with unprecedented
                  detail and artistic vision through ultra high-quality generation processes.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground pl-11">
                  Our proprietary enhancement platform transforms raw AI output into ultra high-quality
                  professional-grade imagery with superior clarity, color accuracy, and resolution that exceeds industry
                  standards.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground pl-11">
                  Every tool in our platform is custom-built, ensuring complete control over ultra high-quality output,
                  performance, and the final artistic vision with supreme quality standards.
                </p>
              </div>
            </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="pt-4 border-t border-border/50">
                      <p className="text-sm text-muted-foreground text-center">
                        "Demonstrating that ultra high-quality AI-generated material from our advanced platform is not
                        just possible, but the future of supreme quality digital imagery."
                      </p>
                    </div>
                  </div>
                </CardContent>

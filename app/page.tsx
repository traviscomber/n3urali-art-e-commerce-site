...
export const metadata: Metadata = {
  title: "n3uralia360.art - Premium 360° Digital Photography & AI-Generated Imagery",
  description:
    "Discover our curated collection of ultra high-quality AI-generated equirectangular and fisheye images, created by our advanced platform. Part of the n3uralia group - delivering supreme quality 4K-16K resolution imagery for projection mapping, VR experiences, and architectural visualization.",
  keywords: [
    "360 photography",
    ...
    "n3uralia group",
    "n3uralia360.art",
    "ultra high quality AI platform",
    "premium generated content",
    "supreme quality imagery",
    "professional AI photography platform",
  ...
  openGraph: {
    title: "n3uralia360.art - Premium 360° Digital Photography & AI-Generated Imagery",
    description:
      "Discover our curated collection of ultra high-quality AI-generated equirectangular and fisheye images, created by our advanced platform. Part of the n3uralia group delivering supreme quality imagery.",
    type: "website",
  ...
  twitter: {
    ...
    title: "n3uralia360.art - Premium 360° Digital Photography & AI-Generated Imagery",
    description:
      "Discover our curated collection of ultra high-quality AI-generated equirectangular and fisheye images, created by our advanced platform. Part of the n3uralia group.",
  },
  alternates: {
        ...
        <div className="relative container mx-auto px-4 py-24 lg:py-32">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <Badge variant="secondary" className="mb-4 animate-pulse-glow">
              Part of n3uralia Group • Premium Digital Photography
            </Badge>
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto text-pretty">
              Discover our curated collection of ultra high-quality equirectangular and fisheye images, generated by our
              advanced AI platform. Part of the n3uralia group, delivering supreme quality imagery for projection
              mapping, VR experiences, and architectural visualization.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <Badge variant="secondary" className="mb-4">
                n3uralia Group Excellence
              </Badge>
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-balance">
                What Makes n3uralia360.art Different?
              </h2>
              <p className="text-muted-foreground text-pretty">
                As part of the innovative n3uralia group, we combine cutting-edge technology with artistic excellence
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  ...
                  <li>• Backed by n3uralia group's quality assurance and innovation standards</li>
                </ul>
              </div>

              <div className="space-y-4">
                <h3 className="text-lg font-semibold">n3uralia Group Platform Excellence:</h3>
                <ul className="space-y-2 text-muted-foreground">
                  <li>
                    • Every image is generated by our advanced AI platform, part of the n3uralia group's supreme quality
                    ecosystem
                  </li>
                  <li>
                    • Professional enhancement pipeline ensures ultra high-quality output across all n3uralia platforms
                  </li>
                  <li>• Unique scenes created by our proprietary n3uralia group technology stack</li>
                  <li>• Equirectangular and fisheye formats for maximum compatibility</li>
                  <li>• Continuous innovation through n3uralia group's research and development initiatives</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground text-pretty">
              Experience the future of digital imagery with our ultra high-quality AI generation and enhancement
              platform, powered by n3uralia group's innovative technology ecosystem, delivering unprecedented quality
              and detail in every 360° image.
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground pl-11">
                  Every image begins with our advanced AI platform, part of the n3uralia group's technology ecosystem,
                  creating unique 360° environments with unprecedented detail and artistic vision through ultra
                  high-quality generation processes.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground pl-11">
                  Our proprietary enhancement platform, developed within the n3uralia group, transforms raw AI output
                  into ultra high-quality professional-grade imagery with superior clarity, color accuracy, and
                  resolution that exceeds industry standards.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground pl-11">
                  Every tool in our platform is custom-built by the n3uralia group, ensuring complete control over ultra
                  high-quality output, performance, and the final artistic vision with supreme quality standards across
                  all group platforms.
                </p>
              </div>
            </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="pt-4 border-t border-border/50">
                      <p className="text-sm text-muted-foreground text-center">
                        "Demonstrating that ultra high-quality AI-generated material from our advanced n3uralia group
                        platform is not just possible, but the future of supreme quality digital imagery."
                      </p>
                    </div>
                  </div>
                </CardContent>

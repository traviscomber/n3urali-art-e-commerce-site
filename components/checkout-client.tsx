...
export function CheckoutClient({ walletAddress, rate, whatsappPhone }: CheckoutClientProps) {
            ...
            <CardContent className="pt-6 space-y-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <Input value={walletAddress} readOnly className="font-mono text-sm bg-muted/50" />
                  <Button
                    variant="outline"
                    size="icon"

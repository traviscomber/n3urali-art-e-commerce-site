...
export function EnvironmentsPageClient({ collections, environmentImages }: EnvironmentsPageClientProps) {
  ...
  const handlePrevPreview = () => {
    setPreviewIndex((prev) => (prev - 1 + previews.length) % previews.length)
  }
  ...
  const currentCollection = collections[0] || {
    ...
    description: 'Continuous atmospheric loops optimized for dome perception and experiential venues.',
    code: 'environments',
  }

...
export function ShopClient() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="w-full py-16 sm:py-24 md:py-32 px-4 sm:px-6 lg:px-8 border-b border-slate-700/60">
      ...
      {/* Filters Section */}
      <section className="w-full py-6 sm:py-8 px-4 sm:px-6 lg:px-8 border-b border-slate-700/60 bg-black/50 sticky top-0 z-40">
      ...
      {/* Info Section */}
      <section className="w-full py-12 sm:py-24 px-4 sm:px-6 lg:px-8 border-t border-slate-700/60">
        <div className="max-w-7xl mx-auto">
      ...
      {/* CTA Section */}
      <section className="w-full py-12 sm:py-24 px-4 sm:px-6 lg:px-8 border-t border-slate-700/60 bg-slate-900/30">
        <div className="max-w-7xl mx-auto text-center">

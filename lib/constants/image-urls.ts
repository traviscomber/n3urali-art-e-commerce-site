...
export const ENVIRONMENT_COLLECTIONS = {
  ...
  mythical: {
    ...
    images: [
      { src: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Characters-PEvMoQDx1v77ybaxG670JXhEvBSvCj.png', alt: 'Mythical Characters' },
      { src: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/SoundNarration-7BDISyqTMo3LOCXV3xpw6FKmxWl1Cc.png', alt: 'Sound Narration' },
      { src: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Story-uHeIC8A58ytbMmyYstH0qzzoxS3n8X.png', alt: 'Story' },
    ],
  ...
  art: {
    ...
    images: [
      { src: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Mastering-UYnsqSuyszIXR99jjR3TuAUMl8i9sH.png', alt: 'Mastering' },
      { src: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Worlds%20building-nlUFsezF77aBtn3Iy4E7BXSWzkAFMt.png', alt: 'World Building' },
      { src: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Story-uHeIC8A58ytbMmyYstH0qzzoxS3n8X.png', alt: 'Art 3' },
    ],
    ctaText: 'Choose environment',

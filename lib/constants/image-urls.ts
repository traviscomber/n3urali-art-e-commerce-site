...
export const ENVIRONMENT_COLLECTIONS = {
  ...
  mythical: {
    ...
    images: [
      { src: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Characters-ekgCbScp6c9ezMs76zqUNAb1evWvoU.png', alt: 'Mythical Characters' },
      { src: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/SoundNarration-zDEzjxlZRjYaZjn870B6s6i2yU0OxK.png', alt: 'Sound Narration' },
      { src: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Story-qYYbn5p8Qa0xNsZx3rRr1XQQgQ4wB8.png', alt: 'Story' },
    ],
  ...
  art: {
    ...
    images: [
      { src: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Mastering-QW0YZFCqT2pbcnocz9c7XejSQVYhYA.png', alt: 'Mastering' },
      { src: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Worlds%20building-IJnwIAnVa0mhhnjyuZ9mc2XlwafY9H.png', alt: 'World Building' },
      { src: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Story-qYYbn5p8Qa0xNsZx3rRr1XQQgQ4wB8.png', alt: 'Art 3' },
    ],
    ctaText: 'Choose environment',

...
const translations = {
  es: {
    ...
    "hero.subtitle": "Ambientes 360° premium creados por algoritmos de IA propietarios que comprenden movimiento, atmósfera y profundidad.",
    "hero.description": "Sin prompts. Sin límites de generación. Sin incertidumbre de derechos de autor. Solo activos inmersivos instantáneos y listos para producción.",
    ...
    "gallery.subtitle": "Deja de perder tiempo en prompts y límites de generación. Explora nuestra colección de ambientes perfectos algorítmicamente que abarcan monumentos patrimoniales, ciudades futuristas e infinitas variaciones atmosféricas—todos descargables instantáneamente.",
    ...
    "gallery.algorithmNote": "Cada imagen potenciada por algoritmos de difusión de ruido propietarios que capturan movimiento, profundidad y riqueza atmosférica en escenarios diversos—desde preservación cultural hasta futuros especulativos",
    "gallery.exploreDataset": "Explora la Diversidad de Conjuntos de Datos Rico",
    "gallery.datasetNote": "Cada categoría representa miles de escenarios de entrenamiento, capturando diversas condiciones de iluminación, clima, períodos de tiempo y atmosféricos",
    ...
    "gallery.heritageDescription": "Nuestro pilar patrimonial captura el alma de monumentos culturales a través de análisis algorítmico avanzado. A diferencia de la fotografía estática, cada cuadro contiene profundidad infinita—el desgaste de piedra antigua, la danza de luz natural sobre arquitectura, el peso atmosférico de siglos.",
    "gallery.heritageUseCase": "Perfecto para museos virtuales, preservación cultural, visualización arquitectónica e inmersión educativa.",
    ...
    "gallery.datasetDescription": "Más allá del patrimonio, nuestro motor algorítmico ha dominado futuros distópicos, paisajes oníricos surrealistas, expansión urbana, fenómenos naturales y ambientes especulativos.",
    ...
    "useCases.subtitle": "A diferencia de herramientas de generación que requieren prompts e iteraciones, nuestra colección curada entrega activos instantáneos con derechos administrados, confiados por profesionales",
    "useCases.gameDev": "Desarrollo de Juegos",
    "useCases.gameDevDesc": "Skyboxes y ambientes para juegos VR/AR. Listos para HDRI, formatos optimizados, integración instantánea en Unity/Unreal.",
    "useCases.virtualProd": "Producción Virtual",
    "useCases.virtualProdDesc": "Fondos para pantallas LED, contenido de mapeo de proyección. Resolución 16K con iluminación auténtica y profundidad atmosférica.",
    "useCases.archViz": "Visualización Arquitectónica",
    "useCases.archVizDesc": "Contextos ambientales realistas para renders arquitectónicos. Monumentos patrimoniales, escenas urbanas, paisajes naturales.",
    "useCases.metaverse": "Metaverso y Web3",
    "useCases.metaverseDesc": "Ambientes de mundos virtuales, fondos NFT, experiencias inmersivas. Activos únicos creados algorítmicamente.",
    "useCases.digitalArt": "Arte Digital y NFTs",
    "useCases.digitalArtDesc": "Obras de arte 360° exclusivas con licencias verificables. Ediciones limitadas, calidad de coleccionista y autenticidad.",
    "useCases.education": "Educación y Museos",
    "useCases.educationDesc": "Tours virtuales, preservación cultural, aprendizaje inmersivo. Sitios patrimoniales capturados con precisión algorítmica.",
    ...
    "comparison.legalDesc": "A diferencia de bibliotecas de stock genéricas donde el contenido generado por IA crea incertidumbre de derechos de autor, cada imagen de n3uralia360.art viene con licencia comercial completa e indemnización.",
  ...
  en: {
    ...
    "hero.subtitle": "Premium 360° environments crafted by proprietary AI algorithms that understand movement, atmosphere, and depth.",
    "hero.description": "No prompts. No generation limits. No copyright uncertainty. Just instant, production-ready immersive assets.",
    ...
    "gallery.subtitle": "Stop wasting time on prompts and generation limits. Browse our collection of algorithmically-perfected environments spanning heritage landmarks, futuristic cities, and infinite atmospheric variations—all instantly downloadable.",
    "gallery.stats.resolution": "16K",
    ...
    "gallery.algorithmNote": "Each image powered by proprietary noise diffusion algorithms that capture movement, depth, and atmospheric richness across diverse scenarios—from cultural preservation to speculative futures",
    "gallery.exploreDataset": "Explore Rich Dataset Diversity",
    "gallery.datasetNote": "Each category represents thousands of training scenarios, capturing diverse lighting, weather, time periods, and atmospheric conditions",
    ...
    "gallery.heritageDescription": "Our heritage pillar captures the soul of cultural landmarks through advanced algorithmic analysis. Unlike static photography, each frame contains infinite depth—the weathering of ancient stone, the dance of natural light across architecture, the atmospheric weight of centuries.",
    "gallery.heritageUseCase": "Perfect for virtual museums, cultural preservation, architectural visualization, and educational immersion.",
    "gallery.exploreHeritage": "Explore Full Heritage Collection",
    "gallery.exploreDatasetTitle": "Explore Rich Dataset Diversity",
    "gallery.datasetDescription": "Beyond heritage, our algorithmic engine has mastered dystopian futures, surreal dreamscapes, urban sprawl, natural phenomena, and speculative environments.",
    
    // Use Cases Section
    "useCases.badge": "Industry Applications",
    "useCases.title": "Production-Ready For",
    "useCases.titleHighlight": "Every Creative Vision",
    "useCases.subtitle": "Unlike generation tools that require prompts and iterations, our curated collection delivers instant, rights-managed assets trusted by professionals",
    "useCases.gameDev": "Game Development",
    "useCases.gameDevDesc": "Skyboxes and environments for VR/AR games. HDRI-ready, optimized formats, instant integration into Unity/Unreal.",
    "useCases.virtualProd": "Virtual Production",
    "useCases.virtualProdDesc": "LED wall backgrounds, projection mapping content. 16K resolution with authentic lighting and atmospheric depth.",
    "useCases.archViz": "Arch Visualization",
    "useCases.archVizDesc": "Realistic environmental contexts for architectural renders. Heritage landmarks, urban scenes, natural landscapes.",
    "useCases.metaverse": "Metaverse & Web3",
    "useCases.metaverseDesc": "Virtual world environments, NFT backgrounds, immersive experiences. Unique, algorithmically-crafted assets.",
    "useCases.digitalArt": "Digital Art & NFTs",
    "useCases.digitalArtDesc": "Exclusive 360° artworks with verifiable licensing. Limited editions, collector-grade quality and authenticity.",
    "useCases.education": "Education & Museums",
    "useCases.educationDesc": "Virtual tours, cultural preservation, immersive learning. Heritage sites captured with algorithmic precision.",
    ...
    "comparison.legalDesc": "Unlike generic stock libraries where AI-generated content creates copyright uncertainty, every n3uralia360.art image comes with full commercial licensing and indemnification.",

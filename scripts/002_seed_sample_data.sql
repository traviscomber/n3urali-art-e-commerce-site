...
INSERT INTO licenses (name, description, price_multiplier, download_limit, commercial_use, resale_rights, attribution_required) VALUES
('Standard', 'Personal and commercial use for single project', 1.00, 5, true, false, true),
('Extended', 'Multiple projects with enhanced usage rights', 2.50, 10, true, false, false),
('Commercial', 'Unlimited commercial use with resale rights', 5.00, 25, true, true, false)
ON CONFLICT (name) DO NOTHING;

-- Insert sample equirectangular images
INSERT INTO images (title, description, category, price, file_url, preview_url, thumbnail_url, metadata, dimensions, file_size, tags, featured) VALUES
...
INSERT INTO orders (user_email, total_amount, status, billing_details) VALUES
('test@example.com', 124.97, 'completed', '{"name": "Test User", "address": "123 Test St", "city": "Test City", "country": "US"}'),
('demo@n3urali.art', 89.98, 'completed', '{"name": "Demo User", "address": "456 Demo Ave", "city": "Demo City", "country": "US"}')
ON CONFLICT DO NOTHING;

-- Insert sample order items
INSERT INTO order_items (order_id, image_id, license_type, price) VALUES
(1, 1, 'extended', 124.97),
(2, 2, 'standard', 39.99),
(2, 1, 'standard', 49.99)
ON CONFLICT DO NOTHING;
